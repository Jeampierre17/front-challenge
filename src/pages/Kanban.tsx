          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 w-full">
            ...
            <Transition.Root show={showFilters} as={React.Fragment}>
              <Dialog as="div" className="relative z-50 sm:hidden" onClose={setShowFilters}>
                <TransitionChild as={React.Fragment} enter="transition-opacity ease-linear duration-200" enterFrom="opacity-0" enterTo="opacity-100" leave="transition-opacity ease-linear duration-200" leaveFrom="opacity-100" leaveTo="opacity-0">
                  <div className="fixed inset-0 bg-black/30" />
                </TransitionChild>
                <div className="fixed inset-0 flex items-end">
                  <TransitionChild as={React.Fragment} enter="transition ease-in-out duration-300 transform" enterFrom="translate-y-full" enterTo="translate-y-0" leave="transition ease-in-out duration-300 transform" leaveFrom="translate-y-0" leaveTo="translate-y-full">
                      ...
                      <div className="flex flex-wrap gap-2">
                        ...
                        <Listbox value={statusFilter} onChange={val => setKanbanFilters({ ...kanbanFilters, status: val })}>
                          <div className="relative min-w-[120px] w-full">
                            <ListboxButton className="flex-1 w-full px-3 py-2 border border-gray-200 dark:border-gray-700 rounded-md bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-gray-100 text-xs text-left focus:outline-none focus:ring-2 focus:ring-purple-400">
                            ...
                            <Transition as={React.Fragment} leave="transition ease-in duration-100" leaveFrom="opacity-100" leaveTo="opacity-0">
                              <ListboxOptions className="absolute left-0 right-0 z-10 mt-1 max-h-48 w-full min-w-[120px] overflow-auto rounded-md bg-white dark:bg-gray-800 py-1 text-xs shadow-lg ring-1 ring-black/5 focus:outline-none">
                ...
                <div className="flex items-center gap-2 bg-gray-100 dark:bg-gray-800 rounded-full px-3 py-1 min-w-[120px]">
                  ...
                  <Listbox value={statusFilter} onChange={val => setKanbanFilters({ ...kanbanFilters, status: val })}>
                    <div className="relative min-w-[80px]">
                      <ListboxButton className="bg-transparent flex items-center gap-1  border-none focus:ring-0 text-sm text-gray-900 dark:text-gray-100 min-w-[80px] text-left">
                        {statusOptions.find(o => o.value === statusFilter)?.label || 'Estado'}
